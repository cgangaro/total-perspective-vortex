...
def getArgsForTrain():
    try:
        parser = argparse.ArgumentParser(
            description='Train EEG Classification Models'
        )
        ...
        parser.add_argument('--save_models_dir', type=str, required=False,
                            help='Directory to save models')
        parser.add_argument('--split_by_subjects', action='store_true',
                            help='Split the dataset by subjects')
